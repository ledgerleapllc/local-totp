...
export const aes256 = {
  ...
  encrypt: function(key, input) {
    ...
    var iv = CryptoJS.randomBytes(16);
    var cipher = CryptoJS.createCipheriv(CIPHER_ALGORITHM, sha256.digest(), iv);
  ...
  decrypt: function(key, encrypted) {
    ...
    var decipher = CryptoJS.createDecipheriv(CIPHER_ALGORITHM, sha256.digest(), iv);
